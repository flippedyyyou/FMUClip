...
if __name__ == "__main__":
    ...
    #     args.model_path = "/datanfs2/shenruoyan/checkpoints/llava-v1.5-7b"
    #     args.ve_name = '/datanfs4/shenruoyan/FMUClip/retrieval/output/clip_flickr_unlearn1k_dog_cliperase_export122503/unlearned_clip'
