...
with open(input_file, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        total += 1
        if 'Donald Trump' in data.get('text', '') or 'Donald' in data.get('text', '') or 'Trump' in data.get('text', '') or "Chihuahua" in data.get('text', '') or 'Hello Kitty' in data.get('text', '') or 'Elon Musk' in data.get('text', '') or 'Musk' in data.get('text', ''):
