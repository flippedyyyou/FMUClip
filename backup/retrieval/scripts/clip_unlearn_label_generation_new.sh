...
runfile=${code_path}/clip_unlearn_label_generation_new.py

# ========= 运行 =========
output=${code_path}/output/clip_flickr_unlearn1k_${neg_mode}_export010201
export_dir=${code_path}/output/clip_flickr_unlearn1k_${neg_mode}_export010201
...
python ${runfile} \
    ...
    --neg_mode ${neg_mode} \
    --max_epoch ${max_epoch} \
    --sam3_mask_dir ${code_path}/mask/flickr/dog/train \
