...
CUDA_VISIBLE_DEVICES=2 python /datanfs4/shenruoyan/FMUClip/classification/generate_sam3_mask.py \
  --jsonl-path "/datanfs4/shenruoyan/FMUClip/classification/data_split/cifar100_forget_plain_complete.jsonl" \
  --output-dir "/datanfs4/shenruoyan/FMUClip/classification/mask/cifar100/train/cifar100_forget_plain_complete" \
