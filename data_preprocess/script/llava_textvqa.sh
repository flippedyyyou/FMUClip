...
ORIGINAL_WEIGHT="/datanfs4/shenruoyan/checkpoints/timm/vit_large_patch14_clip_336.openai"
...
# CUDA_VISIBLE_DEVICES=0 python /datanfs4/shenruoyan/FMUClip/llava/eval/model_vqa_loader_unlearned.py \
