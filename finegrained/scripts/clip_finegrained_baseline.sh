...
METHOD="original"
RETAIN_TOPK=5
OUTPUT_DIR="/datanfs4/shenruoyan/FMUClip/finegrained/output/original_eval/${METHOD}_${FORGET_CLASSES}5_DF${LAMBDA_DF}_DR${LAMBDA_DR}_UNI${LAMBDA_UNI}_$(date +%m%d%H%M)"
