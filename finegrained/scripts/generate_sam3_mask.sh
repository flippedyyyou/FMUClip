...
CUDA_VISIBLE_DEVICES=2 python /datanfs4/shenruoyan/FMUClip/finegrained/generate_sam3_mask.py \
  --image-list "/datanfs4/shenruoyan/FMUClip/data/classification/coco2017_instances/train/Df/item3/banana.txt" \
  --image-root "/datanfs4/shenruoyan/datasets/coco2017/train2017" \
  --output-dir "/datanfs4/shenruoyan/FMUClip/finegrained/mask/coco/item3/banana/train" \
  --prompt "banana" \
