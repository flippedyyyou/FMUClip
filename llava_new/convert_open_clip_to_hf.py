...
if __name__ == "__main__":
    ...
    file_name = args.pretrained.replace('.pt', '')
    torch.save(state_dict, f'{file_name}_model.pt')
    print(f"Saved state dict to {file_name}_model.pt")

    convert_clip_checkpoint(args.model, f'{file_name}_model.pt', args.pytorch_dump_folder_path, args.config_path)